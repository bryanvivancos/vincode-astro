...
demosTitle: "Programas"
benefits: [
  {
    id: 1,
    icon: "ShieldIcon",
    title: 'Software Original y Verificado',
    description: 'Garantizamos licencias legítimas, actualizables y seguras, sin riesgos de bloqueos o errores por software no autorizado.',
  },
  {
    id: 2,
    icon: "ComputerIcon",
    title: 'Instalación en Cualquier Sistema Operativo',
    description: 'Brindamos soporte completo para Windows y macOS, asegurando compatibilidad total con tu entorno de trabajo.',
  },
  {
    id: 3,
    icon: "CogIcon",
...
faqData: [
  {
    id: 1,
    question: '¿Qué tipos de software ofrecen?',
    answer: 'Microsoft Office, antivirus, herramientas de productividad, software empresarial, aplicaciones creativas y más — siempre 100% originales.',
  },
  {
    id: 2,
    question: '¿Incluye instalación y configuración?',
    answer: 'Sí. Nos encargamos de la instalación completa, activación de licencia y optimización para que funcione sin problemas.',
  },
  {
    id: 3,
    question: '¿Funciona en cualquier sistema operativo?',
    answer: 'Sí, damos soporte para Windows, macOS y Linux, según disponibilidad del software elegido.',
  },
  {
    id: 4,
